...
const { types, scopes, scopeOverrides, allowCustomScopes, upperCaseSubject } = require(__dirname +
  "/cz-config.js");
...
Object.keys(scopeOverrides).forEach((k) =>
  Array.prototype.push.apply(validScopes, scopeOverrides[k])
);
